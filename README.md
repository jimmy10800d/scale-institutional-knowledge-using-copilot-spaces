...
- Copilot Spaces let you organize the context that Copilot uses to answer your questions.
  <!-- Copilot Spaces 讓你組織 Copilot 用來回答問題的上下文 -->
- Spaces can include repositories, code, pull requests, issues, free-text content like transcripts or notes, images, and file uploads.
  <!-- Spaces 可以包含儲存庫、程式碼、拉取請求、議題、自由文本內容(如記錄或筆記)、圖片和檔案上傳 -->
...
<!-- 只需將練習複製到你的帳戶,然後給你最喜歡的 Octocat (Mona) **大約 20 秒**來準備第一課,然後**刷新頁面** -->
...
<details>
<summary>Having trouble? 🤷 遇到問題?</summary>

When copying the exercise, we recommend the following settings:
<!-- 複製練習時,我們建議以下設定: -->

- For owner, choose your personal account or an organization to host the repository.
  <!-- 對於擁有者,選擇你的個人帳戶或組織來託管儲存庫 -->

- We recommend creating a public repository, since private repositories will use Actions minutes.
  <!-- 我們建議建立公開儲存庫,因為私有儲存庫會使用 Actions 分鐘數 -->

If the exercise isn't ready in 20 seconds, please check the [Actions](../../actions) tab.
<!-- 如果練習在 20 秒內未準備好,請檢查 Actions 標籤 -->

- Check to see if a job is running. Sometimes it simply takes a bit longer.
  <!-- 檢查是否有工作正在執行。有時只是需要多一點時間 -->
